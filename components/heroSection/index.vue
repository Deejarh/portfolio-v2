...
<template>
  <section id="hero" class="relative lg:h-screen mx-4  ">
    ...
    <div class=" hero-section flex flex-col justify-center items-center gap-2  mb-2">
        <client-only>
            ...
            <div class=" greetings   lg:text-sm font-semibold px-5 my-5 lg:my-4  py-1 rounded-full border border-gray-200 font-urbanist">👋<span class="ml-2 lg:ml-1"> Hi</span> </div>
            ...
            <p class=" text-color font-overlock text-xs lg:text-sm -mt-2"> Empowering the web, One line of code at a time.</p>
             <div class=" lg:mt-6 mt-10 w-[76px] h-[73px]"><img src="assets/HeroScroll.gif"></div>
