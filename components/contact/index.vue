...
<template>
   ...
   <div class=" dark:text-black-1 flex justify-center lg:flex-row flex-col items-center lg:gap-20 gap-12 ">
    <div class="flex items-center  lg:px-4 lg:py-3 py-2 px-3 text-sm  border border-gray-1 rounded-full cursor-pointer hover hover:opacity-70 hover:rounded-full">
    ...
    <div class="cursor-pointer text-start  flex  flex-col  lg:items-start items-center  gap-y-2">
      ...
      <div class="flex gap-x-3 items-center my-3  ">
        ...
        <a href="https://twitter.com/kha_deejarh" aria-label="Twitter link" target="_blank" class="cursor-pointer  hover:opacity-70 hover:rounded-full">
          <twitter-icon/>
        </a>
