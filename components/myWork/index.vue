...
const projects = ref([
  ...
  },
  {
    ...
    tools: ["Vue", "Typescript","Nodejs", "Rest API","Html", "TailwindCSS","Payment SDK"],
  },
  {
    title: "Send Money",
    ...
    tools: ["Vue", "Javascript","Nodejs", "Rest API", "Html", "TailwindCSS", "Vuex", "Element UI","Axios"],
  },
  {
